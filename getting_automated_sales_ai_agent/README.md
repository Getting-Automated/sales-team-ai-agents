...
- Modify `src/getting_automated_sales_ai_agent/config/agents.yaml` to define your agents
- Modify `src/getting_automated_sales_ai_agent/config/tasks.yaml` to define your tasks
- Modify `src/getting_automated_sales_ai_agent/crew.py` to add your own logic, tools and specific args
- Modify `src/getting_automated_sales_ai_agent/main.py` to add custom inputs for your agents and tasks
